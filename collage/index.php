...
<head>
    ...
    <title>PMS Collage : Dashboard</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                    ...
                    <div class="card alert">
                        ...
                        <div class="card-body">
                            <div class="horizontal-form">
                                <form class="form-horizontal" method='POST' role='form' action='add_student.php'>
                                    <input type='hidden' name='in_Id' id='in_Id' class='form-control' type='text'>
                                    <input type='hidden' name='ad_UserRoleId' id='ad_UserRoleId' value='4' class='form-control' type='text'>
                        ...
                        <div class="card-body">
                            <table class="table table-responsive table-hover">
                                <tbody>
                                    ...
                                    $result = $dbConn->query("select * from tbl_users where user_role_id like '%4%'");
